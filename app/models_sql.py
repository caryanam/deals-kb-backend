...
class PaymentTransaction(Base):
    ...
    listing_id = Column(String(100), nullable=True, index=True)
    payment_type = Column(String(50), nullable=True, index=True)
    amount = Column(DECIMAL(12, 2), nullable=False)
    currency = Column(String(10), nullable=False, default="INR")
    payment_gateway = Column(String(30), nullable=False, default="ccavenue", index=True)
    order_id = Column(String(100), unique=True, nullable=True, index=True)
    gateway_tracking_id = Column(String(100), nullable=True, index=True)
    ...
    status = Column(Enum("PENDING", "SUCCESS", "FAILED", "ABORTED", "INVALID", "AWAITED"), default="PENDING", index=True)
