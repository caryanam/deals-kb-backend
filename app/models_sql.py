...
class PaymentTransaction(Base):
    ...
    payment_gateway = Column(String(30), nullable=False, default="cashfree", index=True)
    cashfree_order_id = Column(String(100), unique=True, nullable=True, index=True)
    cashfree_payment_session_id = Column(Text)
    cashfree_order_status = Column(String(30), index=True)
